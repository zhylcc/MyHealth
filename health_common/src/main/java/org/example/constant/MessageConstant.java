...
public class MessageConstant {
    ...
    public static final String QUERY_CHECKITEMLIST_SUCCESS = "查询检查项列表数据成功";
    public static final String QUERY_CHECKITEMLIST_FAIL = "查询检查项列表数据失败";
    public static final String LOGIN_FAIL = "登录失败";

    public static final String GET_USERDETAIL_FAIL = "查询用户详情失败";
    public static final String GET_USERDETAIL_SUCCESS = "查询用户详情成功";
}
